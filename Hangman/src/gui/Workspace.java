...
public class Workspace extends AppWorkspaceComponent {
    ...
    private void layoutGUI() {
        ...
        guessedalready = new HBox();
        remainingGuessBox = new HBox();
        gameTextsPane = new VBox();

        gameTextsPane.getChildren().setAll(remainingGuessBox, guessedLetters, guessedalready, hintbox);
    ...
    private void setupHandlers() {
        ...
        hint2.setOnMouseClicked(e->controller.handleHintRequest());
    }
    ...
    public HBox gethintbox() {return hintbox;}

    public Button gethint2() {return hint2;}
    ...
    public void reinitialize2(){
        ...
        gameTextsPane = new VBox();
        guessedalready = new HBox();
        gameTextsPane.getChildren().setAll(remainingGuessBox, guessedLetters,guessedalready);
